    ...
    stages {
       ...
       stage('Make A Builder Image') {
            steps {
                ...
                script {
                    builderImage = docker.build("${ACCOUNT_REGISTRY_PREFIX}/example-webapp-builder", "-f ./Dockerfile.builder .")
                    builderImage.push()
        ...
        stage('Build Production Image') {
            steps {
                ...
                script {
                    productionImage = docker.build("${ACCOUNT_REGISTRY_PREFIX}/example-webapp")
